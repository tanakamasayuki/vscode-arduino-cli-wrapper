...
const MSG = {
  en: {
    ...
    versionCheckPlatformGroupHeading: 'Platform updates',
    versionCheckLibraryGroupHeading: 'Library updates',
    versionCheckBtnUpdatePlatformGroup: 'Update all {name}',
    versionCheckBtnUpdateLibraryGroup: 'Update all {name}',
    ...
    commandCenterLocalPortHelperTitle: 'Local Port Rules',
    ...
    commandCenterCliNone: 'No direct arduino-cli command (handled inside VS Code).',
    commandCenterVersionCli: 'arduino-cli version',
    commandCenterUpdateCli: 'arduino-cli update',
    commandCenterUpgradeCli: 'arduino-cli upgrade',
    commandCenterCacheCleanCli: 'arduino-cli cache clean',
    commandCenterListBoardsCli: 'arduino-cli board list',
    commandCenterListAllBoardsCli: 'arduino-cli board listall [filters]',
    commandCenterBoardDetailsCli: 'arduino-cli board details -b <fqbn>',
    ...
    commandCenterRunArbitraryCli: 'arduino-cli <arguments entered at runtime>',
  ...
  ja: {
    ...
    commandCenterLocalPortHelperTitle: 'ローカルポート設定',
    ...
    commandCenterCliNone: 'arduino-cli の直接実行はありません (VS Code 内で処理します)。',
    commandCenterVersionCli: 'arduino-cli version',
    commandCenterUpdateCli: 'arduino-cli update',
    commandCenterUpgradeCli: 'arduino-cli upgrade',
    commandCenterCacheCleanCli: 'arduino-cli cache clean',
    commandCenterListBoardsCli: 'arduino-cli board list',
    commandCenterListAllBoardsCli: 'arduino-cli board listall [フィルター]',
    commandCenterBoardDetailsCli: 'arduino-cli board details -b <FQBN>',
    ...
    commandCenterRunArbitraryCli: 'arduino-cli <入力した引数>',
    ...
    versionCheckPlatformGroupHeading: 'プラットフォーム別更新',
    versionCheckLibraryGroupHeading: 'ライブラリー別更新',
    versionCheckBtnUpdatePlatformGroup: '{name} をすべて更新',
    versionCheckBtnUpdateLibraryGroup: '{name} をすべて更新',
...
const COMMAND_CENTER_ITEMS = Object.freeze([
  { command: 'arduino-cli.version', titleKey: 'commandCenterVersionTitle', descKey: 'commandCenterVersionDesc', requiresProfile: false, cliKey: 'commandCenterVersionCli' },
  { command: 'arduino-cli.update', titleKey: 'commandCenterUpdateTitle', descKey: 'commandCenterUpdateDesc', requiresProfile: false, cliKey: 'commandCenterUpdateCli' },
  { command: 'arduino-cli.upgrade', titleKey: 'commandCenterUpgradeTitle', descKey: 'commandCenterUpgradeDesc', requiresProfile: false, cliKey: 'commandCenterUpgradeCli' },
  { command: 'arduino-cli.cacheClean', titleKey: 'commandCenterCacheCleanTitle', descKey: 'commandCenterCacheCleanDesc', requiresProfile: false, cliKey: 'commandCenterCacheCleanCli' },
  { command: 'arduino-cli.listBoards', titleKey: 'commandCenterListBoardsTitle', descKey: 'commandCenterListBoardsDesc', requiresProfile: false, cliKey: 'commandCenterListBoardsCli' },
  { command: 'arduino-cli.listAllBoards', titleKey: 'commandCenterListAllBoardsTitle', descKey: 'commandCenterListAllBoardsDesc', requiresProfile: false, cliKey: 'commandCenterListAllBoardsCli' },
  { command: 'arduino-cli.boardDetails', titleKey: 'commandCenterBoardDetailsTitle', descKey: 'commandCenterBoardDetailsDesc', requiresProfile: false, cliKey: 'commandCenterBoardDetailsCli' },
  { command: 'arduino-cli.sketchNew', titleKey: 'commandCenterSketchNewTitle', descKey: 'commandCenterSketchNewDesc', requiresProfile: false, cliKey: 'commandCenterSketchNewCli' },
  { command: 'arduino-cli.refreshView', titleKey: 'commandCenterRefreshViewTitle', descKey: 'commandCenterRefreshViewDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.buildCheck', titleKey: 'commandCenterBuildCheckTitle', descKey: 'commandCenterBuildCheckDesc', requiresProfile: false, cliKey: 'commandCenterBuildCheckCli' },
  { command: 'arduino-cli.versionCheck', titleKey: 'commandCenterVersionCheckTitle', descKey: 'commandCenterVersionCheckDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.sketchYamlHelper', titleKey: 'commandCenterSketchYamlHelperTitle', descKey: 'commandCenterSketchYamlHelperDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.examples', titleKey: 'commandCenterExamplesTitle', descKey: 'commandCenterExamplesDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.setProfile', titleKey: 'commandCenterSetProfileTitle', descKey: 'commandCenterSetProfileDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.setFqbn', titleKey: 'commandCenterSetFqbnTitle', descKey: 'commandCenterSetFqbnDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  ...
  { command: 'arduino-cli.localPortHelper', titleKey: 'commandCenterLocalPortHelperTitle', descKey: 'commandCenterLocalPortHelperDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  ...
  { command: 'arduino-cli.monitor', titleKey: 'commandCenterMonitorTitle', descKey: 'commandCenterMonitorDesc', requiresProfile: false, cliKey: 'commandCenterMonitorCli' },
  { command: 'arduino-cli.debug', titleKey: 'commandCenterDebugTitle', descKey: 'commandCenterDebugDesc', requiresProfile: true, cliKey: 'commandCenterDebugCli' },
  { command: 'arduino-cli.configureWarnings', titleKey: 'commandCenterConfigureWarningsTitle', descKey: 'commandCenterConfigureWarningsDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  ...
  { command: 'arduino-cli.openSecretsHeader', titleKey: 'commandCenterOpenSecretsTitle', descKey: 'commandCenterOpenSecretsDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
  { command: 'arduino-cli.createSecretsHeader', titleKey: 'commandCenterCreateSecretsTitle', descKey: 'commandCenterCreateSecretsDesc', requiresProfile: false, cliKey: 'commandCenterCliNone' },
]);
...
async function embedAssetsForSketch(sketchDir, options = {}) {
  ...
  try {
    const targets = await detectSketchAssetFolders(sketchDir, { includeDefaultWhenMissing: createDirIfMissing });
    if (!targets.length) {
    ...
    for (const target of targets) {
      ...
      if (!silent) {
        if (result.status === 'noAssets') {
          vscode.window.showWarningMessage(t('embedAssetsNoAssets', {
            assets: result.assetsPath,
            header: result.headerPath
          }));
        } else if (result.status !== 'missingDir') {
...
function buildVersionCheckStrings() {
  const keys = [
    ...
    'versionCheckPlatformGroupHeading',
    'versionCheckLibraryGroupHeading',
    'versionCheckBtnUpdatePlatformGroup',
    'versionCheckBtnUpdateLibraryGroup',
...
async function detectSketchAssetFolders(sketchDir, options = {}) {
  const { includeDefaultWhenMissing = false } = options || {};
  const results = [];
  const seen = new Set();
  const defaultKey = DEFAULT_ASSETS_DIR.toLowerCase();
  const baseDir = String(sketchDir || '').trim();
  if (!baseDir) return results;
  try {
    const entries = await vscode.workspace.fs.readDirectory(vscode.Uri.file(baseDir));
    for (const [name, type] of entries) {
      if (type !== vscode.FileType.Directory) continue;
      if (!isAssetsFolderName(name)) continue;
...
function isAssetsFolderName(name) {
  ...
  const lower = trimmed.toLowerCase();
  if (lower === DEFAULT_ASSETS_DIR) return true;
  return lower.startsWith(`${DEFAULT_ASSETS_DIR}_`);
}
...
async function buildAssetsHeaderContent(sketchDir, assetsDir, folderName, records, config) {
  ...
  lines.push(`const char* const ${groupSymbol}_file_names[${groupSymbol}_file_count] = {`);
  for (let i = 0; i < fileNames.length; i++) {
    const suffix = (i + 1) < fileNames.length ? ',' : '';
    lines.push(`  ${fileNames[i]}${suffix}`);
  }
  lines.push('};');
  lines.push(`const uint8_t* const ${groupSymbol}_file_data[${groupSymbol}_file_count] = {`);
  for (let i = 0; i < dataSymbols.length; i++) {
    const suffix = (i + 1) < dataSymbols.length ? ',' : '';
    lines.push(`  ${dataSymbols[i]}${suffix}`);
  }
  lines.push('};');
  lines.push(`const size_t ${groupSymbol}_file_sizes[${groupSymbol}_file_count] = {`);
...
function makeAssetGroupSymbol(folderName) {
  const raw = String(folderName || DEFAULT_ASSETS_DIR);
  let base = raw.replace(/[^0-9A-Za-z]+/g, '_').replace(/_+/g, '_').replace(/^_+|_+$/g, '');
  if (!base) base = DEFAULT_ASSETS_DIR;
  if (!/^[A-Za-z_]/.test(base)) base = `${DEFAULT_ASSETS_DIR}_${base}`;
  return base;
}
...
async function reportAssetsEmbedDiagnostics(sketchDir) {
  ...
  const sketchKey = normalizeSketchKey(sketchDir);
  const folders = await detectSketchAssetFolders(sketchDir);
  if (!folders.length) {
    clearUnusedAssetDiagnostics(sketchKey);
    return;
  }
  ...
  for (const folder of folders) {
    ...
    if (!headerExists || headerMtime < newest) {
      ...
      const message = headerExists
        ? t('embedAssetsOutdated', { file: newestFile, folder: folderName, header: headerUri.fsPath })
        : t('embedAssetsMissing', { file: newestFile, folder: folderName, header: headerUri.fsPath });
      setAssetsDiagnostic(diagKey, targetUri, message);
    } else {
      clearAssetsDiagnostic(diagKey);
    }
  }
  clearUnusedAssetDiagnostics(sketchKey, processed);
}
...
function makeAssetsDiagKey(sketchKey, folderName) {
  return `${sketchKey}::${String(folderName || DEFAULT_ASSETS_DIR).toLowerCase()}`;
}
...
function clearUnusedAssetDiagnostics(sketchKey, keepKeys) {
  try {
    const prefix = `${sketchKey}::`;
    const removals = [];
    for (const key of assetsDiagTargets.keys()) {
